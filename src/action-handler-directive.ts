...
// TODO You need to replace all instances of "action-handler-pallone" with "action-handler-<your card name>"
customElements.define('action-handler-pallone', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-pallone')) {
    return body.querySelector('action-handler-pallone') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-pallone');
